...
In order to create a pleasant reading experience, I decided to go with [Montserrat](https://fonts.google.com/specimen/Montserrat) in different weights. [Space Mono](https://www.colophon-foundry.org/custom-projects/space-mono) is reserved for highlights, such as the navigation bar, CTAs and footer links. It's a fixed-width type family font, so it doesn't provide as much reading flow compared to Montserrat.
